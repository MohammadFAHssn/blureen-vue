...
const selectedEmShiftType = ref(props.user.emCommuteServiceStation.emCommuteService.emShiftType.id)
const selectedEmCity = ref(props.user.emCommuteServiceStation.emCommuteStation.emCity.id)
const selectedMainStreet = ref(props.user.emCommuteServiceStation.emCommuteStation.mainStreet)
const selectedSideStreet = ref(props.user.emCommuteServiceStation.emCommuteStation.sideStreet)
const selectedStation = ref(props.user.emCommuteServiceStation.emCommuteStation.boardingPlace)
    ...
    <VCard>
      <VCardText>
        <h4 class="text-h5 text-center mb-2">
          ویرایش ایستگاه پرسنل: {{ user.fullName }}
        </h4>
